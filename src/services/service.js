...
class Service {
  ...
  constructor(authKey) {
    ...
    //You should create it in configuration and then set it below.
    //Ex: this.baseUrl = this.config.SAFERIDE_API_BASE_URL_STAGING;
    this.baseUrl = this.config.SAFERIDE_API_BASE_URL;
